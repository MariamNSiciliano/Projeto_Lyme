...
​Clique no badge "Open In Colab" localizado no início do arquivo .ipynb.
​Certifique-se de realizar o upload do dataset necessário mencionado no notebook (Lyme Disease Dataset).